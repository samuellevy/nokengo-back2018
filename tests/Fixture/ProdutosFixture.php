...
class ProdutosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'recorrencia' => ['type' => 'string', 'length' => null, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'tempo_trabalho' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'tempo_trabalho' => 1,
            'created' => '2017-09-05 23:11:04',
            'modified' => '2017-09-05 23:11:04'
        ],
    ];
}
